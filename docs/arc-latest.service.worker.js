...
/** @type {string} */
const CACHE_VERSION = '1787826831|5514694';
/** @type {string} */
const CACHE_PREFIX = 'Arc-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'arc-latest.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["arc-latest.html","arc-latest.js","arc-latest.offline.html","arc-latest.icon.png","arc-latest.apple-touch-icon.png","arc-latest.audio.worklet.js","arc-latest.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["arc-latest.wasm","arc-latest.pck"];
